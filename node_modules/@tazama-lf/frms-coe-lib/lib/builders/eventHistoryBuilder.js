...
async function eventHistoryBuilder(manager, eventHistoryConfig) {
    ...
    manager.saveInDataModelTable = async (tableName, key, data, tenantId, creDtTm) => {
        const query = {
    ...
    // ----
    manager.saveAccount = async (key, tenantId, creDtTm) => {
        const query = {
    ...
    manager.saveGovernedAsCreditorByEdge = async (conditionId, accountEntityId, conditionEdge) => {
        ...
        const queryRes = await manager._eventHistory.query(query);
