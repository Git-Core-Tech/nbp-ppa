...
export type DatabaseManagerType = Partial<ManagerStatus & EventHistoryDB & RawHistoryDB & EvaluationDB & ConfigurationDB & EnrichmentDB & RedisService>;
type DatabaseManagerInstance<T extends ManagerConfig> = ManagerStatus & (T extends {
    ...
    enrichment: DBConfig;
} ? EnrichmentDB : Record<string, unknown>) & (T extends {
    redisConfig: RedisConfig;
 ...
 */
export declare function CreateDatabaseManager<T extends ManagerConfig>(config: T, hooks?: DatabaseManagerHooks): Promise<DatabaseManagerInstance<T>>;
export declare function CreateStorageManager<T extends ManagerConfig>(requiredStorages: Array<Database | Cache>, requireAuth?: boolean, hooks?: DatabaseManagerHooks): Promise<{
